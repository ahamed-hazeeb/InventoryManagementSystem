        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, "supply@chain.com", "SupplyChain Inc." }
                });

            migrationBuilder.InsertData(
                table: "InventoryItems",
                columns: new[] { "Id", "Description", "Name", "Price", "Quantity", "SupplierId" },
                values: new object[,]
                {
                    { 1, "High-end laptop", "Laptop", 1000m, 10, 1 },
                    { 2, "24-inch monitor", "Monitor", 300m, 15, 2 }
                });
